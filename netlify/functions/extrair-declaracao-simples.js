...
- "anexo": o anexo do Simples Nacional em que a atividade está enquadrada ("I", "II", "III", "IV" ou "V"). Primeiro procure um rótulo explícito (ex: "Anexo I", "Comércio", "Indústria", "Serviços") na tabela de composição do débito/receita do documento. Se não vier explícito, infira a partir da atividade/CNAE descrita na declaração, seguindo estas regras do Simples Nacional (LC 123/2006):
  - Revenda de mercadorias / comércio varejista ou atacadista → "I".
  - Fabricação/industrialização de produtos → "II".
  - Serviços de manutenção e reparação (veículos, máquinas, equipamentos), locação de bens móveis, transporte municipal de cargas, escritórios de serviços contábeis → "III".
  - Construção de imóveis e obras de engenharia, serviços advocatícios, vigilância/limpeza, transporte intermunicipal/interestadual de passageiros → "IV".
  - Serviços intelectuais/profissionais regulamentados (medicina, odontologia, psicologia, engenharia, consultoria, auditoria, arquitetura, publicidade etc.) dependem do "Fator R" (% da folha de pagamento dos últimos 12 meses sobre a receita bruta dos últimos 12 meses): "III" se Fator R ≥ 28%, "V" se for menor. Só devolva "III" ou "V" pra essas atividades se o documento trouxer a folha de pagamento (ou o Fator R já calculado) pra você confirmar — senão devolva null e explique em "observacao" que depende do Fator R, que não veio no documento.
  - Se a atividade descrita for mista (comércio + serviço, por exemplo) sem segregação clara de receita por anexo, ou for ambígua/não identificável, devolva null e explique o motivo em "observacao" — nunca invente.
