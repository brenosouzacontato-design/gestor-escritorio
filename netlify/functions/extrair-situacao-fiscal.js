...
//     dividasAtivas: [{inscricao, valor, situacao}], observacao: string }

const ANTHROPIC_API_URL = 'https://api.anthropic.com/v1/messages';
const MODELO = 'claude-haiku-4-5-20251001';

const SYSTEM_PROMPT = `Você é um assistente contábil brasileiro. Recebe um Relatório de Situação Fiscal emitido pela Receita Federal (RFB) e extrai as informações principais dele.

Devolva APENAS um JSON, sem texto antes ou depois, sem markdown e sem crases, no formato exato:
{"dataEmissao":"YYYY-MM-DD ou null","situacaoGeral":"regular"|"pendente"|null,"debitos":[{"tributo":"string","valor":number,"situacao":"string"}],"parcelamentos":[{"modalidade":"string","valor":number,"parcelas":"string"}],"dividasAtivas":[{"inscricao":"string","valor":number,"situacao":"string"}],"observacao":"string curta"}
...
- Se não houver nenhum item numa das três listas, devolva array vazio [], não null.
        ...
        messages: [
          {
            ...
            content: [
              ...
              { type: 'text', text: `Extraia os dados do Relatório de Situação Fiscal "${filename}".` },
            ],
          },
        ],
      }),
